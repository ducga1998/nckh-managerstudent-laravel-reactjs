													...
													<div class="m-card-user m-card-user--skin-dark">
														...
														<div class="m-card-user__details">
															<span class="m-card-user__name m--font-weight-500">
																@if(session('statut') == 'admin' ) {{$NameAdmin}} @endif @if(session('statut') == 'user' ) {{$TenSv}} @endif @if(session('statut')
																== 'redac' ) {{$TenGiangVien}} @endif

															</span>
															<a href="" class="m-card-user__email m--font-weight-300 m-link">
																@if(session('statut') == 'admin' ) {{$GmailAdmin}} @endif @if(session('statut') == 'user' ) id {{$IdSinhVien}} @endif @if(session('statut')
																== 'redac' ) {{$TenGiangVien}} @endif
															</a>
														</div>
													</div>
			...
			<div class="m-grid__item m-grid__item--fluid m-wrapper">
				...
				<div class="m-content">
					...
					<div class="m-portlet hiden">
						...
						<!--begin::Form-->
						<form  id="FormAddGiangVien" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
							{!! csrf_field() !!}
					...
					@section('m-content') @if(session('statut') == 'admin' ) @section('Adminshow')
					<h1>Welcome Admin</h1>
					{!!$GmailAdmin!!} @show @elseif( session('statut') == 'user') @section('UserShow') @else @section('TeacherShow') @show @endif
					@show
						@show
				</div>
...
//   });
 $("#FormAddGiangVien").on("submit", function(e) {
   e.preventDefault();
        ...
        var bomon = $("#exampleSelect1").find(":selected").val();
   ...
   $.ajax({
	...
	$(".notice-sucess").html("Thêm Giảng Viên tên:"+name+" Có Pass là"+password+" thành Công");
